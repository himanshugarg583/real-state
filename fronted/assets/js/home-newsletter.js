...
jQuery("#Newsletter").submit(function(e) {
    ...
    function valid_contact() {
        ...
        var fname = document.querySelector('#Newsletter #fname');
        var lname = document.querySelector('#Newsletter #lname');
        ...
        if (fname.value == '') {
            document.querySelector('#Newsletter #error_data').innerHTML = '* Please Enter First Name.';
        ...
        if (!alpha.test(digit)) {
            document.querySelector('#Newsletter #error_data').innerHTML = '* Invalid Name: ' + fname.value;
            fname.style.borderColor = "red";
            fname.value = '';
            fname.focus();
            return false;
        ...
        if (lname.value == '') {
            document.querySelector('#Newsletter #error_data').innerHTML = '* Please Enter Last Name.';
        ...
        var alpha = /^[a-zA-Z-,]+(\s{0,1}[a-zA-Z-, ])+(\s{0,1}[a-zA-Z-, ])*$/;
        if (!alpha.test(digit)) {
            document.querySelector('#Newsletter #error_data').innerHTML = '* Invalid Name: ' + lname.value;
            lname.style.borderColor = "red";
            lname.value = '';
            lname.focus();
            return false;
